...
log_dir = "/om/user/ehoseini/MyData/KeRNL/logs/kernel_rnn_v1/two_optimizaer/MNIST_tr_step_%.1e_batch_%.1e_hidd_%.1e_gc_%.1e_run_%s" %(training_steps,batch_size,num_hidden,grad_clip, datetime.now().strftime("%Y%m%d_%H%M"))
